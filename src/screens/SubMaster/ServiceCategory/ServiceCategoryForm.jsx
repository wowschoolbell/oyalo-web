            ...
            <Form
              ...
              <Row gutter={[15, 0]}>
                <Col md={{span: 6}} xs={{span: 24}}>
                  <Form.Item name='name' label='Service Category' rules={[{required: true, message: 'Please add level'}]}>
                    <Input name='name' placeholder='Service Category' disabled={savingEmployeeLevel} />
                  </Form.Item>
                </Col>
