      ...
      <Menu.Item key="u1">
        <div style={{ textAlign: "center" }}>
          <Avatar
            ...
            src={userData ? JSON.parse(userData)?.data?.image : ""}
          />
          <div>{userData ? JSON.parse(userData)?.data?.name : ""}</div>
          <div>{userData ? JSON.parse(userData)?.data?.email : ""}</div>
        </div>
      </Menu.Item>
          ...
          <Dropdown
            ...
            <Space>
              <Avatar
                ...
                className="mt-4"
                src={JSON.parse(userData)?.data?.image}
              />
            </Space>
          </Dropdown>
        </Menu.Item>
