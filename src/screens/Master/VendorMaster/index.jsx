...
export default function VendorMaster() {
  ...
  return <CustomTable handleEditClick={handleEditClick} loading={gettingAuditSubCategory} dataSource={gridData} column={column} onClickAdd={onClickAdd} title={'Vendor Master'} />;
}
