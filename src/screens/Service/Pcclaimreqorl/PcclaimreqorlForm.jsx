            ...
            <Form
              ...
              <Row gutter={[15, 0]}>
                <Col md={{span: 6}} xs={{span: 24}}>
                  <Form.Item name='Expense Date' label='Expense Date'>
                    <Input placeholder='Vani' type='date' name='ticketNo' disabled defaultValue={''} />
                  </Form.Item>
                </Col>
                <Col md={{span: 6}} xs={{span: 24}}>
                ...
                <Col md={{span: 6}} xs={{span: 24}}>
                  <Form.Item name='Bill Copy' label='Bill Copy'>
                    <Input placeholder='' type='file' name='Bill Copy' />
                  </Form.Item>
                </Col>
                <Col span={24}>
