...
import PcadvancereqmsAssign from './PcaclaimsubmissionmsAssign';
import PcadvancereqmsOpen from './PcaclaimsubmissionmsOpen';
const {TextArea} = Input;

const {Option} = Select;

function PcaclaimsubmissionmsForm() {
              ...
              <Row gutter={[15, 0]}>
                <Col md={{span: 6}} xs={{span: 24}}>
                  <Form.Item name='Name' label='Name'>
                    <Input placeholder='Vani' name='ticketNo' disabled defaultValue={'Vani'} />
                  </Form.Item>
                </Col>
                <Col md={{span: 6}} xs={{span: 24}}>
...
export default memo(PcaclaimsubmissionmsForm);
